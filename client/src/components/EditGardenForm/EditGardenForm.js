import '../AddGardenForm/gardenForm.css'
...
function EditGardenForm({formCoordinates, gardenToEdit}) {
  ...
  return ( 
    <form className='Garden-form' onSubmit={handleSubmit(async (data) => await submitEditGardenForm(data))}>   
      <h1 
        className='Garden-form-header'
      >
      ...
      <div style={{width:'100%'}}>
        ...
        <div className='Garden-form-row' style={{alignItems:'center'}}> {/* Fee & Vacancy & Wheelchair Access */}
          <div className='Garden-form-element'>
