...
// import MessageBoardIndex from './MessageBoardIndex'
...
const MessageBoard = ({ onSubmit, posts }) => {
...
const MessageBoardPopulated = () => {
  ...
  return (
    <div className='MessageBoardPopulated'>
      <MessageBoardPopulated posts={posts} onSubmit={submitPost} />
    </div>
  )
}
